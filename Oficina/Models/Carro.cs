    ...
    public class Carro
    {
        ...
        public Pneu PneuTrazeiroDireito
        {
            ...
            set 
            {
                if (VelocidadeAtual == 0)
                    ...
                    Console.WriteLine("Troque o pneu Trazeiro Direito. ");
            }
        }
            ...
            set 
             {
                if (VelocidadeAtual == 0)
                    ...
                    Console.WriteLine("Troque o pneu Trazeiro Esquerdo. ");
             }
        }
        public Pneu PneuDianteiroDireito
        {
            ...
            set 
            {
                if (VelocidadeAtual == 0)
                    ...
                    Console.WriteLine("Troque o pneu Dianteiro Direito. ");
            }
        }
        public Pneu PneuDianteiroEsquerdo
        {
            ...
            { if (VelocidadeAtual == 0)
                    ...
                    Console.WriteLine("Troque o pneu Dianteiro Esquerdo. ");
            }
        }
        public bool Ligado
        {
